...
func (suite *FunctionalSuiteRunnerTestSuite) TestRunFunctionalSuites() {
	...
	mockSuite.On("Run", mock.Anything, mock.Anything, mock.Anything).Return(func() error { return nil }, nil)
