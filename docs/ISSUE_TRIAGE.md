...
GitHub labels help organize, categorize, and prioritize GitHub issues.  The main categories of labels being used are:
...
2. Otherwise, assign the appropriate priority label to the issue, add the appropriate comments to the issue, remove the `needs-triage` label, and assign it to the correct milestone.
